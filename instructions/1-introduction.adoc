...
This demo will walk you thorough 2 phases (_Assess_, _Rationalize_) as following steps:
   ...
   3. Deploy the modernized applications to Kubernetes/OpenShift using https://access.redhat.com/documentation/en-us/openshift_container_platform/4.10/html-single/cicd/index#gitops[OpenShift GitOps (ArgoCD)^]
